    ...
    return(
        <form className={style.conteiner}>
            ...
            <div className={style.conteinerRotulo}>
                <p className={style.rotulo}>BMenor</p>
                <p className={style.rotulo}>BMaior</p>
                <p className={style.rotulo}>Altura</p>
                <p className={style.rotuloA}>Área</p>
            </div>            
